...
public class TelaContador extends javax.swing.JFrame {
    ...
    // Classe responsável pelos estados do Slider de inicio
    ...
    // Classe responsável pelos estados do Slider de fim
    ...
    // Classe responsável pelos estados do Slider de passo
    ...
    // Classe responsável pela impressão dos intervalos da estrutura de controle na caixa de Lista
    private void btnContActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContActionPerformed
        // TODO add your handling code here:
        
        int i = sliInicio.getValue(); // Pega o valor selecionado no slider inicio
        int f = sliFim.getValue();  // Pega o valor selecionado no slider fim
        int p = sliPasso.getValue(); // Pega o valor selecionado no slider passo
        
        
        DefaultListModel lista = new DefaultListModel(); // Instancia um objeto da Classe DefaultListModel para 
                                                         //adicionar todos os valores da estrutura de controle
        
        for(int contador = i; contador <= f; contador += p){
            lista.addElement(contador); // Adiciona os valores do contador na lista;
        }
        
        lsCont.setModel(lista); // Mostrar os valores da lista na caixa de lista da tela.
    ...
    private javax.swing.JList lsCont;
